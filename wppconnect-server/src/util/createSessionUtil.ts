...
export default class CreateSessionUtil {
  ...
  async createSessionUtil(
    ...
    try {
      ...
      // autoClose no ultimo assign: a lib usa 60000 ms por default se nao sobrescrever aqui
      const createOpts = req.serverOptions.createOptions || {};
      const wppClient = await create(
        Object.assign(
          ...
          createOpts,
          {
            ...
            autoClose: createOpts.autoClose ?? 0,
          }
        )
      );
