...
**Painel da Evolution:** Use `http://SEU_IP:8080/manager` para gerenciar instâncias. Na primeira vez, informe a URL da API (`http://SEU_IP:8080`) e a chave (`AUTHENTICATION_API_KEY` do .env).
